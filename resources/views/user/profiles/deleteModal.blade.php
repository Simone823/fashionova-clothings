{{-- Button --}}
<button type="button" class="btn btn-danger text-uppercase" data-bs-toggle="modal" data-bs-target="#deleteUserModal">
    Elimina Account
</button>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content bg-body-secondary">
            <div class="modal-header border-0">
                <h1 class="modal-title text-danger fw-bold fs-5" id="deleteUserModalLabel">
                    Elimina Account
                </h1>
