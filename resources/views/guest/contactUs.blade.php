                    ...
                    <div class='card bg-body-secondary border-0 shadow-sm p-4'>
                        <form action="{{route('guest.contactUs.store')}}" method="POST" class='row'>
                            ...
                            <div class="col-12 col-md-6 mb-4 form-group">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{old('name')}}" placeholder="Il tuo nome" >
                            ...
                            <div class="col-12 col-md-6 mb-4 form-group">
                                ...
                                <input type="text" class="form-control @error('surname') is-invalid @enderror" id="surname" name="surname" value="{{old('surname')}}" placeholder="Il tuo cognome" >
                            ...
                            <div class="col-12 col-md-6 mb-4 form-group">
                                ...
                                <input type="tel" class="form-control @error('phone') is-invalid @enderror" id="phone" name="phone" value="{{old('phone')}}" placeholder="Il tuo numero di telefono" >
                            ...
                            <div class="col-12 mb-4 form-group">
                                ...
                                <textarea class="form-control @error('message') is-invalid @enderror" id="message" name="message" placeholder="Scrivi il tuo messaggio..." >{{old('message')}}</textarea>
                            ...
                            <div class="col-12 mb-5">
                                <div class="form-check form-switch">
                                    <input class="form-check-input @error('privacy_check') is-invalid @enderror" type="checkbox" role="switch" id="privacy_check" name="privacy_check" value="{{old('privacy_check')}}" >
