...
@section('metaTitle', "Modifica Ruolo: {$role->name}")

@section('content')
    <section id="admin-roles-edit">
                    ...
                    <div class="row gy-4 mb-5">
                        ...
                        <div class="col-12 form-group d-flex flex-wrap gap-3">
                            ...
                            @foreach ($permissions as $key => $permission)    
                                <input {{$role->permissions->contains($permission) ? 'checked' : '' }} type="checkbox" class="btn-check" id="permissions-{{$permission->id}}" name="permissions[]" value="{{$permission->id}}">
