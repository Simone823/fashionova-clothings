        ...
        <div class="modal-content bg-body-secondary">
            <div class="modal-header">
                <h1 class="fs-5 fw-bolder" id="changePasswordUserModalLabel">
                    <i class="fa-solid fa-lock fs-5 me-1"></i>
                    Cambia Password
                </h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{route('admin.profiles.changePassword', $user->id)}}" method="POST">
                    @csrf
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-danger text-uppercase" data-bs-dismiss="modal">
