                    ...
                    <div class="row gy-4 mb-5">
                        ...
                        @foreach ($sizes as $size)
                            <div class="col-12 col-md-6 form-group">
                                ...
                                <input type="number" class="form-control" id="size-{{ $size->id }}" name="sizes[{{ $size->id }}]" placeholder="Inserisci la quantità disponibile" value="{{ old("sizes.{$size->id}", $product->sizes->firstWhere('id', $size->id)->pivot->quantity_available ?? '') }}" min="1">
